	...
	<div class="row" id="adminPage">
		<div class="col-md-6">
			<div class="card p-2 m-0">
				...
				<div class="card-body" style="max-height: 480px; overflow-y: auto; border-bottom-left-radius: 8px; border-bottom-right-radius: 8px;">
					<?php
					$i = 1;
					if (empty($admin)) {
					?>
		...
		<div class="col-md-6">
			<div class="card p-2">
				<div class="card-header">
					<div class="row">
						<div class="col">
							<h4 class="card-title">Kelola Label</h4>
			...
			<div class="modal-content" style="width: 950px;">
				<div class="card p-2 mb-0">
					<div class="card-header">
						<div class="row">
							<div class="col">
								<h4 class="card-title" id="addTagModalLabel">Tambah Label</h4>
								<p class="card-category">Label / Tambah Label</p>
							</div>
							<div class="col d-flex justify-content-end">
								<button type="button" class="close" data-dismiss="modal">&times;</button>
							</div>
					...
					<div class="modal-body">
						<form role="form" action="<?php echo base_url('Admin/saveTag') ?>" method="post" enctype="multipart/form-data">
							<div class="card-body p-0">
								<div class="row">
									<div class="col">
										<label for="tagTraining" class="my-2">Nama Label <span style="color: red;">*</span></label>
										<input type="text" class="form-control input-pill mb-3" name="nameTag" id="nameTag" placeholder="Masukkan Nama Label Baru" required="">
									</div>
									<div class="col">
