            ...
            <div class="col-md-12">
                <div class="card p-2 mb-3">
                    <div class="card-header">
                        <div class="row">
                            <div class="col">
                                <h4 class="card-title">AWI Knowledge</h4>
                                <p class="card-category">AWI Knowledge</p>
                            </div>
            ...
            <div class="row" id="articlesContainer">
                ...
                foreach ($forum as $t) { ?>
                    <div class="col-sm-3 card-item fade-in">
                        <div class="card card-flip" style="border-radius: 20px;" onclick="showDetailFRM(<?php echo $t->FRM_ID ?>)">
                            <div class="card-header">
            ...
            if (xhr.readyState === XMLHttpRequest.DONE) {
                if (xhr.status === 200) {
                    ...
                    data.forEach(function(item) {
                        ...
                        const cardHTML = `
                                <div class="col-sm-3 card-item fade-in">
                                    <div class="card card-flip" onclick="showDetailFRM(${item.FRM_ID})" style="border-radius: 20px;">
                                        <div class="card-header">
                                            <div class="image-article">
            ...
            fetch('<?= base_url('Article/showDetail/') ?>' + id)
                ...
                .then(data => {
                    ...
                    if (dataFRM) {
                        ...
                        if (dataFRM.FRM_STATUS == '1' && '<?php echo $this->session->userdata['role']; ?>' == 'admin') {
